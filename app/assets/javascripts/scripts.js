            ...
            ArtX.el.eventCalendar = ArtX.el.calendarContainer.clndr({
                ...
                clickEvents: {
                    ...
                    onMonthChange: function(month) {
                        ...
                        jsonURL = "/public/json/events-august.json"; // temporary URL for testing
    ...
    init: function() {
        if (ArtX.el.calendarContainer.length > 0) {
            ...
            var eventArray = [],
                thisMonth,
                thisMonthURL,
                julyEventURL = "/public/json/events-july.json",
                augEventURL = "/public/json/events-august.json";
        ...
        ArtX.loadMore.vars.loadMoreLink
            ...
            .click(function() {
                ...
                switch(temporaryJsonURL) {
                    case "/LoadFavorites/" :
                        ArtX.loadMore.vars.nextPageJsonURL = "/public/json/loadFavorites-page" + ArtX.loadMore.vars.nextPage + ".json";
                        break;
                    default:
                        ArtX.loadMore.vars.nextPageJsonURL = "/public/json/loadFavorites-page" + ArtX.loadMore.vars.nextPage + ".json";
                }
    ...
    init: function() {
        if (ArtX.loadMore.vars.loadMoreLink.length > 0) {
            ...
            if (currentItemsCount == ArtX.var.itemsPerPage) {
                ...
                switch(temporaryJsonURL) {
                    case "/LoadFavorites/" :
                        ArtX.loadMore.vars.nextPageJsonURL = "/public/json/loadFavorites-page2.json";
                        break;
                    default:
                        ArtX.loadMore.vars.nextPageJsonURL = "/public/json/loadFavorites-page2.json";
                }
